...
function [best,fmin,N_iter]=bat_algorithm(n, N_gen,A,r,data,testdata,sig_size,d_lim)
% Display help
...
d=sig_size;           % Number of dimensions 
...
for i=1:n,
  randvec = rand(1,sig_size);  
%   randvec(randvec < 0) = 0;
  Sol(i,:)=Lb+(Ub-Lb).*randvec;
  Fitness(i)=Fun(Sol(i,:),data,testdata);
end
